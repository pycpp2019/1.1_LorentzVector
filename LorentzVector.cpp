...
LorentzVector LorentzVector::add(const LorentzVector& v) const {return LorentzVector(v.t() + ct1, v.x() + x1, v.y() + y1, v.z() + z1);}
LorentzVector LorentzVector::sub(const LorentzVector& v) const {return LorentzVector(-v.t() + ct1, -v.x() + x1, -v.y() + y1, -v.z() + z1);}
LorentzVector LorentzVector::mul(double a) const {return LorentzVector(a * ct1, a * x1, a * y1, a * z1);}